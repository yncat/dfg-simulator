...
describe("countSequencialCardsFrom", () => {
  it("can count sequencial cards", () => {
    ...
    expect(h1.countSequencialCardsFrom(4, false)).toBe(0);
    expect(h2.countSequencialCardsFrom(4, false)).toBe(1);
    expect(h3.countSequencialCardsFrom(4, false)).toBe(3);
  });
  ...
  it("can count sequencial cards when the strength is inverted", () => {
    ...
    expect(h1.countSequencialCardsFrom(4, true)).toBe(0);
    expect(h2.countSequencialCardsFrom(4, true)).toBe(2);
    expect(h3.countSequencialCardsFrom(6, true)).toBe(3);
  });
});
